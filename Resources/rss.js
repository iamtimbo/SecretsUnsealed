...
var RSS_URL = "mobileweb" === osname ? "/feed.xml" : "http://feeds.mashable.com/Mashable?format=xml";
...
var getRssText = function(item, key) {
    return "mobileweb" === osname ? item.getElementsByTagName(key).item(0).textContent : item.getElementsByTagName(key).item(0).text;
};
